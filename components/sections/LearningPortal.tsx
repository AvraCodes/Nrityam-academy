...
export default function LearningPortal({ reverseLayout = false }: { reverseLayout?: boolean }) {
  ...
  return (
 <section className="relative py-12 sm:py-24 md:py-32 bg-transparent overflow-hidden z-10" id="portal">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-primary/20 bg-white/45 dark:bg-white/5 backdrop-blur-xl shadow-2xl p-2 pb-0">
                ...
                <div className="rounded-t-xl bg-white dark:bg-white/5 dark:bg-white/5 border border-primary/10 border-b-0 overflow-hidden relative shadow-inner">
                  ...
                  <div className="aspect-video relative bg-black flex flex-col justify-between overflow-hidden">
                    <img src="/bg_studio.png" alt="Studio Setup" className="absolute inset-0 w-full h-full object-cover opacity-60" />
                    <div className="absolute inset-0 bg-gradient-to-tr from-primary/80 via-primary-dark/80 to-secondary-dark/80 opacity-60 mix-blend-multiply" />
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-16 h-16 rounded-full bg-white/60 dark:bg-white/5 backdrop-blur flex items-center justify-center border border-white shadow-lg text-primary cursor-pointer hover:scale-110 transition-transform z-10">
